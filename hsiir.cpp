...
static float tplv_maxsqr()
{
  ...
  sumr.f[1] = suml.f[3];
  suml.v = _mm_max_ps(suml.v, sumr.v);
  return (suml.f[1] > suml.f[0] ? suml.f[1] : suml.f[0]);
}

extern "C"
float _n(hsiirv_tpl)(float* pbuf, long nsamp)
{
  float tpl_max = 0.0f;
...
extern "C"
void _n(hsiir_init)(double *pcoffs)
{
...
extern "C"
void _n(hsiir_eval_blk)(float *pbuf, long nsamp, float *pdst)
{
  pdst[1] = _n(hsiirv_tpl)(pbuf, nsamp);
...
extern "C"
float _n(hsiir_tpl)(float* pbuf, long nsamp)
{
    float tpl_max = 0.0f;
...
void _n(hsiir_eval_blk)(float *pbuf, long nsamp, float *pdst)
{
  pdst[1] = _n(hsiir_tpl)(pbuf, nsamp);
